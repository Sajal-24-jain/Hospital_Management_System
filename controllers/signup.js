    ...
    db.getuserid(email, function (err, result) {
      ...
      var output =
        ...
        `</li>
            ...
            <p>verify Link: <a href="https://hospital-management-system-ggyi.onrender.com/views/verify">Verify</a></p>
      ...
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
          user: "hellooowoorld12@gmail.com",
          pass: "xerjsegzxluydept",
        },
      });
      var mailOptions = {
        from: "hellooowoorld12@gmail.com",
        to: email,
